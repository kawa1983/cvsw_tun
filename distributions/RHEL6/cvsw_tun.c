/*
 *  TUN - Universal TUN/TAP device driver for CVSW.
 *  Copyright (C) 1999-2002 Maxim Krasnyansky <maxk@qualcomm.com>
 *  Copyright (C) 2014 Ryota Kawashima <kawa1983@nitech.ac.jp>
 *
 ...
 *  Changes:
 *
 *  Ryota Kawashima <kawa1983@nitech.ac.jp> 2014/09/01
 *    Add CVSW extensions for tunneling.
 *
...
#define DRV_DESCRIPTION	"Universal TUN/TAP device driver for CVSW"
#define DRV_COPYRIGHT	"(C) 1999-2004 Max Krasnyansky <maxk@qualcomm.com>\n(C) 2014 Ryota Kawashima <kawa1983@nitech.ac.jp>"
 ...
 * CVSW extension (BEGIN)
 ***************************************************************************/
		if (gso.gso_type & (VIRTIO_NET_HDR_GSO_UDP_TUNNEL | 
				    VIRTIO_NET_HDR_GSO_GRE_TUNNEL)) {

		    skb->encapsulation = 1; /* VM's packet is encapsulated */
